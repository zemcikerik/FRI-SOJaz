TITLE MASM CV5PR1    (main.asm)
INCLUDE Irvine32.inc

; Nacitajte cele cislo v rozsahu <-32 768; 32 767>. Vypocitajte hodnotu cisla a ulozte ju do registra AX.

.data
Dlzka EQU 1 + 5 + 1
Retazec DB Dlzka DUP(?)

SpravaZadajteCislo DB "Zadajte cislo z rozsahu <-32 768, 32 767>: ", 0
...
main PROC
  ...
  Kladne:
    ...
    ; pracujeme s cislami so znamienkom, tie maju v hornych bitoch 1 ak su zaporne inak 0
    ; preto pouzijeme instrukciu movsx na rozsirenie cisla, tato instrukcia doplne chybajuce bity podla znamienka
    movsx EAX, AX
    call WriteInt
